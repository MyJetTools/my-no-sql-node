...
#[http_route(
    method: "POST",
    route: "/api/Bulk/CleanAndBulkInsertByChunksCancel",
    input_data: "CancelBulkProcessInputContract",
    summary: "Cancels a chunked clean-and-bulk-insert operation",
...
pub struct CleanAndBulkInsertByChunksCancelAction {
    app: Arc<AppContext>,
}

impl CleanAndBulkInsertByChunksCancelAction {
...
async fn handle_request(
    action: &CleanAndBulkInsertByChunksCancelAction,
