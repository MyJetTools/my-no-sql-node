...
pub fn MiniChart(
    ...
    // The label is html over the svg: the svg stretches with `preserveAspectRatio="none"`, and
    // text inside it would stretch along.
    rsx! {
        div { class: "mini-chart-wrap",
            ...
            span { class: "mini-chart__label", "{label}" }
        }
    }
}
